...
PICS = (environ.get('PICS', 'https://envs.sh/pxR.jpg')).split() #SAMPLE PIC
...
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/xyzmovie_hub'))
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movierequesthub6383')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/hhublyyefxcc')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/hhsoccso8853') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : Mrkillersss')
...
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1002257386991")).split())) 
OWNER_USERNAME = "LazyDeveloper"


# add premium logs channel id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002227794424'))
